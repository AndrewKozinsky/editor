...
export default function ModalShortContent(props) {
    ...
    return (React.createElement("section", { className: CN.root }, header &&
        React.createElement(Wrapper, { b: 10 }, React.createElement(Header, { text: header, type: 'h2' })), text &&
        React.createElement("div", { className: CN.content }, React.createElement("p", null, text)), bottomElems &&
