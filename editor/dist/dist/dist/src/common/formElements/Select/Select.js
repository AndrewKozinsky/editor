...
export default function Select(props) {
    ...
    return (React.createElement(React.Fragment, null, React.createElement(Label, { label: label, id: id }), React.createElement("div", { className: CN.wrapper }, React.createElement("select", Object.assign({}, inputAttribs), getOptions(options)), React.createElement("div", { className: CN.wrapperTip }, React.createElement(SvgIcon, { type: 'selectInputArrows', baseClass: '-icon-stroke' })))));
}
