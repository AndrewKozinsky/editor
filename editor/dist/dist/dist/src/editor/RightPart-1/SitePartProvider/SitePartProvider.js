...
export default function SitePartProvider() {
    ...
    useEffect(function () {
        ...
        const parts = [0, 1, 2, 3].map((num) => {
            if (num === 0) {
                return (React.createElement(HeaderPage, { headerText: rightTabsMsg.sites, display: num === rightMainTab, key: num }, React.createElement(SiteSection, null)));
            }
            else if (num === 1) {
                return (React.createElement(HeaderPage, { headerText: rightTabsMsg.siteTemplates, display: num === rightMainTab, key: num }, React.createElement(React.Fragment, null, React.createElement(NewTemplateButton, null), React.createElement(TemplatesList, null)), currentTemplateId !== null && React.createElement(SiteTemplateForm, null)));
            }
            else if (num === 2) {
                return (React.createElement(HeaderPage, { headerText: rightTabsMsg.components, display: num === rightMainTab, key: num }, React.createElement(FoldersList, { type: 'components' }), React.createElement(ComponentFormProvider, null)));
            }
            else if (num === 3) {
                return (React.createElement(HeaderPage, { headerText: rightTabsMsg.articles, display: num === rightMainTab, key: num }, React.createElement(FoldersList, { type: 'articles' }), React.createElement(ArticleFormProvider, null)));
            }
        });
