 ...
 */
export function checkProp(propValue, propName, propType, required, checkChildrenFn) {
 ...
 */
export function checkForExtraProps(parentObj, validProps) {
    const errorsArr = [];
 ...
 */
export function checkForDifferentObjAttrValuesInArr(arr, propName) {
    const result = {};
    arr.forEach((arrItem) => {
...
//# sourceMappingURL=checkFns.js.map
//# sourceMappingURL=checkFns.js.map
//# sourceMappingURL=checkFns.js.map