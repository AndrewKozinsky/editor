...
export default function EditArticleSection() {
    ...
    return (React.createElement(React.Fragment, null, React.createElement(Wrapper, { t: 20 }), React.createElement(Hr, null), React.createElement(Wrapper, { t: 20, align: 'right', verticalAlign: 'center', gap: 20 }, !isArticleInEditor ? React.createElement(EditArticle, null) : React.createElement(InEditor, null))));
}
// TODO Что делает эта функция?
...
function InEditor() {
    ...
    return (React.createElement(React.Fragment, null, React.createElement("p", { className: CN.tip }, articleFormMsg.articleIsAlreadyEdited), React.createElement(Button, { onClick: toEditorFn, text: articleFormMsg.toEditor, icon: 'btnSignExit', color: 'accent' })));
}
