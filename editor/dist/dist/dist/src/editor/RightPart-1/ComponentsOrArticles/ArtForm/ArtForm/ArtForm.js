...
export default function ArtForm() {
    ...
    return (React.createElement(React.Fragment, null, React.createElement(FormConstructor, { config: config, state: formState }), React.createElement(EditArticleSection, null)));
}
