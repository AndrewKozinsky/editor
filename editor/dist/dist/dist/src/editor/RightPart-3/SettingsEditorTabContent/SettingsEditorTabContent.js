...
export default function SettingsEditorTabContent() {
    return (React.createElement("div", null, React.createElement(Wrapper, null, React.createElement(LanguageSection, null)), React.createElement(Wrapper, { t: 20 }, React.createElement(ThemeSection, null))));
}
