 ...
 */
function getClasses(scaleDownType) {
    const classes = [CN];
    if (scaleDownType === 'scaleDown')
        classes.push(`${CN}--scale-down`);
    if (scaleDownType === 'scaleDownTransparent')
        classes.push(`${CN}--scale-down-transparent`);
    return classes;
}
//# sourceMappingURL=EditorMain-classes.js.map
//# sourceMappingURL=EditorMain-classes.js.map
//# sourceMappingURL=EditorMain-classes.js.map