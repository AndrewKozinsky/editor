...
export default function DragFilesTree(props) {
    ...
    return (React.createElement("div", { "data-file-tree": 'true', style: { minWidth: minWidth } }, React.createElement(Wrapper, { b: 10 }, React.createElement(Button, { text: newFolderName, icon: 'btnSignFolder', onClick: (e) => {
            createNewFolder(e, null, props.items, props.setItems, after);
        } })), React.createElement(Wrapper, { b: 10 }, React.createElement(Button, { text: newFileName, icon: 'btnSignAdd', onClick: (e) => {
...
function generateItems(allItems, innerItems, setItems, offset, after) {
    ...
    return innerItems.map(itemData => {
        ...
        return (React.createElement(Fragment, { key: itemData.id }, React.createElement(Item, { items: allItems, itemData: itemData, setItems: setItems, offset: offset, after: after }), innerItems));
    });
}
