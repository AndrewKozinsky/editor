 ...
 */
export default function useFormConstructorState(formConfig, outerFns = {}) {
    const [fields, setFields] = useState(getInitialFieldsState(formConfig));
    const updateField = useCallback((fieldName, newFieldData) => {
    ...
    const onFormSubmit = useCallback((e) => {
        formSubmitHandler(e, fields, setFields, submitCounter, setSubmitCounter, formConfig, setSubmitBtnDisabled, setFormDisabled, setSubmitBtnLoading, setCommonError, setFormVisible, setFormSentSuccessfully, outerFns, commonSuccess, showCommonSuccess, formData, setFormData, serverMsg);
    }, [
...
//# sourceMappingURL=useFormConstructorState.js.map
//# sourceMappingURL=useFormConstructorState.js.map
//# sourceMappingURL=useFormConstructorState.js.map