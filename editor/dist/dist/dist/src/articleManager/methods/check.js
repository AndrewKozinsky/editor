 ...
 */
export function canMakeHistoryStep(step, historyArr, currentIdx) {
    return ((step === 'undo' && currentIdx - 1 !== -1) ||
 ...
 */
export function isArticleSave(historyStepWhenWasSave, historyCurrentIdx) {
