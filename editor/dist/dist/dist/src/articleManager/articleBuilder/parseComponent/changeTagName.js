 ...
 */
export function changeTagName(consistObj) {
 ...
 */
function getTagName(dElem, tempElem) {
    if (!dElem.dCompElemTag)
        return null;
    // If tag is a string, that is a ready tag name.
    if (typeof dElem.dCompElemTag === 'string')
    ...
    // Return tag name
    if (tagData)
        return tagData.elemTagValueName;
    return null;
}
//# sourceMappingURL=changeTagName.js.map
//# sourceMappingURL=changeTagName.js.map
//# sourceMappingURL=changeTagName.js.map