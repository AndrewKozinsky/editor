...
export default function Button(props) {
    ...
    if (id)
        btnAttrs.id = id;
    return (React.createElement("button", Object.assign({}, btnAttrs), React.createElement(ButtonIcon, { iconType: icon, color: color, CN: CN }), React.createElement(ButtonLoader, { loading: loading }), btnText));
}
/* Значок на кнопке */
