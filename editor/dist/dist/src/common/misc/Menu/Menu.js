...
export default function Menu(props) {
    ...
    const $items = items.map((item, i) => {
        return (React.createElement("li", { className: CN.li, key: i }, React.createElement(MenuLink, { to: item.to, label: item.label, key: i })));
    });
    return (React.createElement("nav", { className: CN.root }, React.createElement("ul", { className: CN.ul }, $items)));
}
