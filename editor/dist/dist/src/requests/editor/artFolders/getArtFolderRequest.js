...
export function getArtFolderRequest(siteId) {
    return __awaiter(this, void 0, void 0, function* () {
        const options = { method: 'GET' };
        const rowResponse = yield makeFetch(getApiUrl('artFoldersBySite', siteId), options);
...
//# sourceMappingURL=getArtFolderRequest.js.map
//# sourceMappingURL=getArtFolderRequest.js.map