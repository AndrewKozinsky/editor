...
export default function CodeCheckInfo(props) {
    ...
    return (React.createElement(Notice, { icon: icon, bg: true }, React.createElement("h4", { className: CN.header }, props.header), props.type === 'codeCheck' && React.createElement(CodeCheck, Object.assign({}, props)), props.type === 'codeExample' && React.createElement(CodeExample, Object.assign({}, props))));
}
...
function CodeExample(props) {
    const { code } = props;
    const CN = makeClasses();
    return (React.createElement("div", { className: CN.code }, React.createElement("pre", null, code)));
}
