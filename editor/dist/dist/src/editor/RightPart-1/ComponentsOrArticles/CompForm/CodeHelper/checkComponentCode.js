...
import { checkForDifferentObjAttrValuesInArr, checkForExtraProps, checkProp } from './checkFns';
 ...
 */
export default function checkComponentCode(code) {
    const errorsArr = [];
    try {
...
function checkElems(elems) {
    ...
    elems.forEach(elem => {
        ...
        errorsArr.push(...checkForExtraProps(elem, ['elemId', 'elemName', 'elemAttrs', 'elemTags', 'elemHidden', 'elemCanDuplicate', 'elemTextInside']));
    });
 ...
 */
export function checkElemAttrs(elemAttrs) {
    const errorsArr = [];
    elemAttrs.forEach(elemAttr => {
        ...
        errorsArr.push(...checkForExtraProps(elemAttr, ['elemAttrId', 'elemAttrName', 'elemAttrAlt', 'elemAttrView', 'elemAttrLockedValue', 'elemAttrValues']));
    });
 ...
 */
export function checkElemAttrValues(elemAttrValues) {
    const errorsArr = [];
    elemAttrValues.forEach(elemAttrValue => {
        ...
        errorsArr.push(...checkForExtraProps(elemAttrValue, ['elemAttrValueId', 'elemAttrValueValue', 'elemAttrValueAlt', 'elemAttrValueChecked']));
    });
 ...
 */
export function checkElemTags(elemTagsObj) {
    const errorsArr = [];
    ...
    errorsArr.push(...checkForExtraProps(elemTagsObj, ['elemTagsValues', 'elemTagsView']));
    return errorsArr;
}
/**
 ...
 */
function checkElemTagsValues(elemTagsValues) {
    const errorsArr = [];
    elemTagsValues.forEach(elemTagsValue => {
        ...
        errorsArr.push(...checkForExtraProps(elemTagsValue, ['elemTagValueId', 'elemTagValueName']));
    });
...
//# sourceMappingURL=checkComponentCode.js.map
//# sourceMappingURL=checkComponentCode.js.map