...
export default function ComponentFormProvider() {
    ...
    if (currentCompItemType === 'folder')
        return React.createElement(CompFolderForm, null);
    else if (currentCompItemType === 'file')
        return React.createElement(CompForm, null);
    return null;
}
//# sourceMappingURL=ComponentFormProvider.js.map
//# sourceMappingURL=ComponentFormProvider.js.map