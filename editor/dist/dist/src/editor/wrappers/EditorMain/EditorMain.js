...
export default function EditorMain() {
    ...
    if (!isVisible)
        return null;
    return (React.createElement(React.Fragment, null, React.createElement("div", { className: CN.root }, React.createElement("div", { className: CN.leftPart }, React.createElement(SectionsTabs, null), React.createElement(EditorPartProvider, { position: 'left' })), React.createElement("div", { className: CN.rightPart }, React.createElement(EditorPartProvider, { position: 'right' }))), React.createElement(Modal, null)));
}
