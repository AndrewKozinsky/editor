import { getItemDataById, hasFolderAnItem, showPlaceMark, moveItemTo } from '../StoreManage/manageState';
/**
 ...
 */
export function handleDragEnd(e, itemData, items, setItems, after) {
 ...
 * @param {Object} itemData — данные перетаскиваемой папки или файла
 */
function isDropAllowed(itemBelowId, itemData) {
 ...
 * @param {Object} itemData — данные перетаскиваемой папки или файла
 */
function getDropPlaceCoords(e, itemBelow, itemBelowId, items, itemData) {
