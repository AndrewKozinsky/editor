 ...
 */
function getInnerWrapperClasses(itemData) {
 ...
 */
function getTriangleBtnClasses(itemData) {
...
// TODO Что делает эта функция?
function getPlaceArrow(itemData) {
    const classes = [PlaceArrCN];
    if (itemData.placeMark === 'before')
        classes.push(PlaceArrCN + '--before');
    if (itemData.placeMark === 'after')
        classes.push(PlaceArrCN + '--after');
    return makeCN(classes);
}
//# sourceMappingURL=DnDItem-classes.js.map
//# sourceMappingURL=DnDItem-classes.js.map