 ...
 */
export function setInLocalStorage(propName, value) {
 ...
 */
export function getFromLocalStorage(propName, defaultValue) {
 ...
 * @param {String} propName — имя свойства
 */
export function removeFromLocalStorage(propName) {
