...
export function getCompFolderRequest(siteId) {
    return __awaiter(this, void 0, void 0, function* () {
        const options = { method: 'GET' };
        const rowResponse = yield makeFetch(getApiUrl('compFoldersBySite', siteId), options);
...
//# sourceMappingURL=getCompFolderRequest.js.map