...
export default function EntrancePages() {
    ...
    return (React.createElement("div", { className: CN.root },
        React.createElement(AuthFormWrapper, null,
            React.createElement(Switch, null,
                React.createElement(Route, { path: '/reg' },
                    React.createElement(RegFormBlock, null)),
                React.createElement(Route, { path: '/confirm-email' },
                    React.createElement(ConfirmEmailFormBlock, null)),
                React.createElement(Route, { path: '/reset-password' },
                    React.createElement(ResetFormBlock, null)),
                React.createElement(Route, { path: '/change-reset-password' },
                    React.createElement(ChangeResetPasswordFormBlock, null)),
                React.createElement(Route, { path: '*' },
                    React.createElement(EnterFormBlock, null))))));
}
