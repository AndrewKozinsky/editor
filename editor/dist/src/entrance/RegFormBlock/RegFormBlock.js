...
export default function RegFormBlock() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Wrapper, { b: 10 },
            React.createElement(Header, { text: regFormMsg.formHeader, type: 'h1' })),
        React.createElement(FormConstructor, { config: config, state: formState }),
        React.createElement(Info, { hide: formState.formSentSuccessfully })));
}
...
function Info(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Wrapper, { t: 20 },
            React.createElement(Notice, null, regFormMsg.legal)),
        React.createElement(Wrapper, { t: 20 },
            React.createElement(Notice, null, regFormMsg.doYouHaveAccount))));
}
