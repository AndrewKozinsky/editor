...
export default function EnterFormBlock() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Wrapper, { b: 10 },
            React.createElement(Header, { text: enterFormMsg.formHeader, type: 'h1' })),
        React.createElement(FormConstructor, { config: config, state: formState }),
        showConfirmEmailMessage && React.createElement(ConfirmLetterMessage, { email: formState.fields.email.value[0] })));
}
...
function ConfirmLetterMessage(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Notice, { icon: 'error', bg: true },
            React.createElement("p", null, enterFormMsg.confirmRegistrationLetter),
            React.createElement(Wrapper, { t: 10, b: 5 },
                React.createElement(Button, { text: enterFormMsg.sendAnotherLetter, loading: isLoading, onClick: doFetch }))),
        error && React.createElement(Wrapper, { t: 10 },
            React.createElement(Notice, { icon: 'error', bg: true }, enterFormMsg.failedToSendAnotherConfirmationLetter)),
        success && React.createElement(Wrapper, { t: 10 },
            React.createElement(Notice, { icon: 'success', bg: true }, enterFormMsg.confirmationLetterWasSent))));
}
