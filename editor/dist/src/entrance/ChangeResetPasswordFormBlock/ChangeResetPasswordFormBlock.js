...
export default function ChangeResetPasswordFormBlock() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Wrapper, { b: 10 },
            React.createElement(Header, { text: changeResetPasswordFormMsg.formHeader, type: 'h1' })),
        React.createElement(FormConstructor, { config: config, state: formState }),
        formState.formSentSuccessfully && React.createElement(PasswordChangedMessage, null)));
}
...
function PasswordChangedMessage() {
    ...
    return (React.createElement(Notice, { bg: true, icon: 'success' },
        React.createElement("p", null, changeResetPasswordFormMsg.passwordChanged),
        React.createElement(Wrapper, { t: 10 },
            React.createElement(Button, { text: changeResetPasswordFormMsg.toEditor, onClick: switchToEditor }))));
}
