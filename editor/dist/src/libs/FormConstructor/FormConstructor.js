...
function FormConstructor(props) {
    ...
    if (!state.formVisible)
        return null;
    return (React.createElement("form", { onSubmit: state.onFormSubmit },
        React.createElement(Fields, { config: config, state: state }),
        React.createElement(BottomDivider, { config: config, state: state }),
        React.createElement(Bottom, { config: config, state: state }),
        React.createElement(Common, { config: config, state: state })));
}
...
function BottomDivider(props) {
    ...
    if (!((_a = props.config.bottom) === null || _a === void 0 ? void 0 : _a.hr))
        return null;
    return (React.createElement(Wrapper, { t: 10 },
