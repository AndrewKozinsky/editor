...
import { addNewFolder, getOpenedFoldersId, toggleFolder, deleteItem, selectItem, addNewLoadingFile } from '../StoreManage/manageState';
/*
 ...
 */
export function useGetToggleFolder(folderId, items, setItems, after) {
 ...
 */
export function createNewFolder(e, folderData, items, setItems, after) {
    e.stopPropagation();
    ...
    if (after.selectItem)
        after.selectItem(result.newItem);
 ...
 * @param {Object} after — объект с различными свойствами и методами переданными в параметрах FilesTree.
 */
export function createNewFile(e, folderData, items, setItems, after) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Обновить Состояние списка папок
        setItems(result.newState);
        const normalFile = Object.assign({}, result.newItem);
        normalFile.id = yield after.addingNewFile();
 ...
 * @param {Object} after — объект с различными свойствами и методами переданными в параметрах FilesTree.
 */
export function removeItem(e, originalItems, setItems, item, after) {
    if (e)
        e.stopPropagation();
 ...
 * @param {Object} after — объект с различными свойствами и методами переданными в параметрах FilesTree.
 */
export function useGetOnClickHandler(items, setItems, itemData, after) {
    return useCallback(function (e) {
