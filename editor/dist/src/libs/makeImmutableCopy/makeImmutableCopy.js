 ...
 */
export default function makeImmutableObj(mainData, originalData, changedData, newData) {
    ...
    if (!isDataHasOriginalData(mainData, originalData))
        return mainData;
 ...
 */
function isDataHasOriginalData(currentData, originalData) {
...
//# sourceMappingURL=makeImmutableCopy.js.map