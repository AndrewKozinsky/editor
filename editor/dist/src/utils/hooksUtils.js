 ...
 */
export default function useGetShowModal(modalContent, modalType) {
    ...
    useEffect(function () {
        if (isModalOpen) {
            ...
            dispatch(actions.modal.openModal({ content: modalContent, type: modalType }));
        }
...
//# sourceMappingURL=hooksUtils.js.map