...
export default function TextInput(props) {
    ...
    return (React.createElement("div", null,
        React.createElement(Label, { label: label, disabled: disabled, id: id }),
        inputType === 'text' &&
            React.createElement("input", Object.assign({}, inputAttribs, { disabled: disabled, id: id, ref: inputRef })),
        inputType === 'textarea' &&
            React.createElement("textarea", Object.assign({}, inputAttribs, { disabled: disabled, id: id, ref: inputRef, rows: rows })),
...
function Error(props) {
    ...
    if (!error)
        return null;
    return (React.createElement(Wrapper, { t: 5 },
        React.createElement(InputError, { text: error })));
}
