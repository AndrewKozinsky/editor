...
export default function Modal() {
    ...
    if (!isOpen)
        return null;
    return (React.createElement("div", { className: CN.outerWrapper, onClickCapture: (e) => onModalClose(e) },
        React.createElement("div", { className: CN.root },
            React.createElement(Button, { icon: 'btnSignClose', onClick: onModalClose, autoFocus: true, extraClass: CN.closeBtn, id: 'modal-close-btn' }),
            content)));
}
