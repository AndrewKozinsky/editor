...
export default function App() {
    ...
    return (React.createElement("div", { className: CN.root },
        React.createElement(Switch, null,
            React.createElement(Route, { path: ['/', '/enter', '/reg', '/reset-password', '/change-reset-password', '/confirm-email'], exact: true },
                React.createElement(EditorMain, null),
                React.createElement(EntrancePages, null)),
