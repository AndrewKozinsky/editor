 ...
 */
export function useFillSiteTemplatesSelect(formState) {
    ...
    useEffect(function () {
        ...
        const newSiteTemplateIdField = Object.assign(formState.fields['siteTemplateId'], {
            options: options,
...
export function useSetAnotherFormData(formState) {
    ...
    useEffect(function () {
        // Обновление поля Имя
        const newNameField = Object.assign(formState.fields['name'], { value: [currentArtName] });
        formState.updateField('name', newNameField);
    }, [currentArtName, siteTemplateId]);
}
//# sourceMappingURL=ArtForm-func.js.map