...
export default function CodeHelper(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Wrapper, { t: 20 },
            React.createElement(CodeCheckInfo, { type: 'codeCheck', checkStatus: checkStatus, header: header, items: errors })),
        React.createElement(Wrapper, { t: 10 },
            React.createElement(CodeCheckInfo, { type: 'codeExample', header: '\u041F\u0440\u0438\u043C\u0435\u0440 \u0448\u0430\u0431\u043B\u043E\u043D\u0430', code: componentCodeExample }))));
}
