...
export default function SiteTemplateForm() {
    ...
    return currentTemplateId ? React.createElement(ExistingSiteTemplateForm, null) : React.createElement(NewSiteTemplateForm, null);
}
...
function NewSiteTemplateForm() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(CodeHelper, { code: formState.fields.content.value[0] })));
}
...
//# sourceMappingURL=siteTemplateForm.js.map