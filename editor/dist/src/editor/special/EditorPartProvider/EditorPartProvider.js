 ...
 */
export default function EditorPartProvider(props) {
    ...
    useEffect(function () {
        ...
        const parts = [0, 1, 2, 3].map(i => {
            const Component = position === 'left'
                ? components['left' + i]
                : components['right' + i];
            return React.createElement(Component, { display: i === mainTab, key: i });
        });
...
//# sourceMappingURL=EditorPartProvider.js.map