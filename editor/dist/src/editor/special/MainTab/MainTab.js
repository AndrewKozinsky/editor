...
export default function MainTab(props) {
    ...
    return (React.createElement("button", Object.assign({}, buttonAttrs),
        React.createElement(SvgIcon, { type: iconType, baseClass: '-icon-fill' }),
        React.createElement(SvgIcon, { type: 'mainTabRoundScion', extraClass: CN.scion }),
        React.createElement(SvgIcon, { type: 'mainTabRoundScion', extraClass: CN.scion })));
}
