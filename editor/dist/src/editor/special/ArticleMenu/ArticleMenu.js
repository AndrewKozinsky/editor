...
export default function ArticleMenuButton() {
    ...
    if (!useIsButtonVisible())
        return null;
    return (React.createElement("div", { className: CN.outerWrapper },
        React.createElement("button", { className: CN.mainButton },
            React.createElement(SvgIcon, { type: 'articleMenu' })),
        React.createElement(ArticleMenu, null)));
}
// TODO Что делает эта функция?
function ArticleMenu() {
    ...
    return (React.createElement("div", { className: CN.menuRoot },
        React.createElement("div", { className: CN.menuSection },
            React.createElement(Button, { text: articleMenuMsg.undo, icon: 'btnSignUndo', onClick: makeUndoStep, disabled: isUndoBtnDisabled }),
            React.createElement(Button, { text: articleMenuMsg.redo, icon: 'btnSignRedo', onClick: makeRedoStep, disabled: isRedoBtnDisabled })),
        React.createElement("div", { className: CN.menuSection },
            React.createElement(Button, { text: articleMenuMsg.markup, icon: 'btnSignCode', onClick: openMarkupModal, disabled: isMarkupBtnDisabled })),
        React.createElement("div", { className: CN.menuSection },
            React.createElement(Button, { text: articleMenuMsg.save, icon: 'btnSignSave', onClick: saveArticle, disabled: isSaveBtnDisabled }),
            React.createElement(Button, { text: articleMenuMsg.close, icon: 'btnSignClose', onClick: closeArticle }),
            React.createElement(Button, { text: articleMenuMsg.delete, icon: 'btnSignTrash', onClick: deleteArticle }))));
}
