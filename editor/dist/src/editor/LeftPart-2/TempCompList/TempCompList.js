...
import { useGetTempCompsFolders, useGetAfterCollapseFolder, useGetOnClickBeforeBtn, useGetOnClickInsideBtn, } from './TempCompList-func';
...
export default function TempCompList() {
    ...
    return (React.createElement(TempCompFilesTree, { items: tempCompsFolders, afterCollapseFolder: afterCollapseFolder, afterClickBeforeBtn: onClickBeforeBtn, afterClickAfterBtn: onClickAfterBtn, afterClickInsideBtn: onClickInsideBtn }));
}
//# sourceMappingURL=TempCompList.js.map