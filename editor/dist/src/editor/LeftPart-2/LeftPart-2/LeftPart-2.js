...
export default function LeftPart2(props) {
    ...
    return (React.createElement("div", { className: CN, style: style },
        React.createElement("div", { className: `${CN}__top` },
            React.createElement(NameSection, { header: componentsPanelMsg.header },
                React.createElement(TempCompList, null))),
        React.createElement("div", { className: `${CN}__bottom` }, "2")));
}
