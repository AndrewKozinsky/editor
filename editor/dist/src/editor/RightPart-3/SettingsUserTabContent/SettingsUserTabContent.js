...
export default function SettingsUserTabContent() {
    ...
    return (React.createElement("div", null,
        React.createElement(Wrapper, null,
            React.createElement(NameSection, { header: userDataSectionMsg.header, type: 2 },
                React.createElement(UserDataForm, null))),
        React.createElement(Wrapper, { t: 25 },
            React.createElement(NameSection, { header: changePasswordSectionMsg.header, type: 2 },
                React.createElement(ChangePasswordForm, null))),
        React.createElement(Wrapper, { t: 25 },
            React.createElement(NameSection, { header: userAccountSectionMsg.header, type: 2 },
                React.createElement(UserAccountForm, null)))));
}
