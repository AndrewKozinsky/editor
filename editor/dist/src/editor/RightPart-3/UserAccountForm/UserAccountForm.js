...
export default function UserAccountForm() {
    ...
    return (React.createElement(Wrapper, { gap: 10 },
        React.createElement(Button, { text: userAccountSectionMsg.deleteBtn, icon: 'btnSignTrash', onClick: deleteAccount }),
        React.createElement(Button, { text: userAccountSectionMsg.logOutBtn, icon: 'btnSignExit', onClick: logOut })));
}
