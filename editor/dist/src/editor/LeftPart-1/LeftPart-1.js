...
export default function LeftPart1(props) {
    ...
    return (React.createElement("div", { className: CN, style: style },
        React.createElement(NameSection, { header: sitesPanelMsg.header },
            React.createElement(NewSiteButton, null),
            React.createElement(SitesButtons, null))));
}
...
function SitesButtons() {
    ...
    return (React.createElement(Wrapper, { t: 10 },
        React.createElement(ItemsList, Object.assign({}, itemsListProps))));
}
