...
export default function FolderForm() {
    ...
    return (
        <Form name='folder' formHandlers={fh.formHandlers}>
            <Wrapper b={15}>
                <TextInput
                    label={messages.ArticlesFolderForm.folderNameInput[lang]}
                    name='name'
            ...
            <Wrapper t={10} align={'right'} gap={10}>
                <Button
                    type='submit'
                    text={messages.ArticlesFolderForm.submitBtnTextSave[lang]}
                    icon='btnSignSave'
                    name='submit'
                ...
                <Button
                    type='button'
                    text={messages.ArticlesFolderForm.deleteFolderBtnText[lang]}
                    icon='btnSignTrash'
