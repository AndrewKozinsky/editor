 ...
 */
export function checkMatchingMarkupWithElems(codeObj: TempCompTypes.Content): string[] {
 ...
 */
function getAllElemsData($rootElem: any, dataNameLong: string, dataName: string): string[] {
 ...
 */
export function isArrayHasEqualValues(arr: string[]) {
    const result: any = {}
 ...
 */
function checkElemsMatching(allDataEmId: string[], elemObjArr: any[]) {
