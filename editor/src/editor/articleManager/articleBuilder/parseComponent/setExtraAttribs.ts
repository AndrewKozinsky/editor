...
export function setExtraAttribs(consistObj: ConsistObj) {
    ...
    consistObj.htmlComp.attrs['data-em-data-comp-id'] = consistObj.dataComp.dCompId.toString()
    // Set dataCompId (component data id) to the element tag
    consistObj.htmlElem.attrs['data-em-data-comp-id'] = consistObj.dataComp.dCompId.toString()
}
