...
export default function useSetServiceStyleToIFrame() {
    ...
    useEffect(function () {
        ...
        styleElem.innerText = `text-component {display:inline;cursor:text}text-component:focus {outline:none;}*[contenteditable]:empty:after {content:attr(placeholder);color: rgba(0, 0, 0, .3);}`
