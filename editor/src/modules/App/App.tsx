...
function App(): ReactElement {
    ...
    // TODO Считаю в атрибуте size нужно передавать не точный размер, например small или middle, а отношение к текущему размеру. Например +1. Если текущий размер small, то при +1 элемент должен быть размером middle.
