...
function App(): ReactElement {
    // TODO Мне кажется все элементы нужно помечать долларом.
    // TODO Что если все файлы с функциями компонента называть вида Menu-func? Всё же имя functions не понятно.
    // TODO У Меню, Заголовка, Текста и Обёртки сделай зависимость от размера интерфейса.
    // TODO В Вёрстка.sketch написан рецепт как делать флаги со своим оформлением. И они анимируются как при выделении, так и при снятии выделения. Посмотри как это реализована и постарайся сделать анимацию у себя на флагах и переключателях.
    // TODO Сделай обёртки для флагов и переключателей куда можно передать название группы и расположение полей.
    // TODO У переключателя можно сделать такую же анимацию как на https://yastatic.net/s3/frontend/lego/storybook/index.html?path=/story/controls-radiobox-desktop--playground
