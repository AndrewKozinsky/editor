...
function App(): ReactElement {
    // TODO При нажатии на кнопку Change нужно делать запрос на смену почты, затем запустить функцию выхода из редактора.
    // TODO Если сменить почту и обновить страницу редактора, то не он откроется. Хотя должна открыться страница входа. Но я не должен иметь возможности войти пока не подтвержу почту.
