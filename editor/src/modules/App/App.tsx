...
export default function App(): ReactElement {
    // TODO Поставь PageHeader и на третью вкладку.
    // TODO Если DividedArea нигде не используется, то удали это компонент
    // TODO Внедри обработчик щелчка по элементу. Обработчик раскрытия/скрытия папки. Обработчик изменения местоположения элемента. Продумай как ставить новый массив данных папок и файлов.
