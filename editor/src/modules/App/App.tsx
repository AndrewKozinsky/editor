...
export default function App(): ReactElement {
    // TODO Перенеси номер активной правой вкладки в Хранилище
    // TODO Поставь правильные значки вкладок и подсказки
    // TODO Поправь стили вкладки

    // TODO Сделай кнопку на всю ширину
    // TODO Сделай чтобы значёк кнопки мог становиться белым.
    // TODO Подумай насчёт того чтобы в компоненте списка пунктов использовать компонент Button потому что он полностью подходит под стиль.
    // TODO Сохраняй в LocalStorage выбранную вкладку в сайтах и настройках и записывай в Хранилище при загрузке страницы.
    // TODO Можно заблокировать вкладку редактора пока не выбрали редактируемый сайт чтобы не писать что для редактирования сначала нужно выбрать сайт. Хотя может лучше написать что для редактирования нужно выбрать сайт. Думаю это будет понятнее.
