...
function App(): ReactElement {
    ...
    // TODO Думаю можно переменную $class переименовать в CN чтобы она была такой же как в TS.
    // TODO Можно сделать чтобы обработчик форм не просто возвращал строку с текстов при появлении ошибки, а любой тип. Например я хочу чтобы у меня было два варианта показа ошибок: первый просто подсвечивает поле красным, а другой показывает текст ошибки. И в зависимости от условыйя буду показывать первый тип, второй или оба.
    ...
    // TODO Удали Формик как закончишь делать свой обработчик форм.
