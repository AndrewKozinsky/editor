...
export default function App() {
    // TODO Можно написать не компонент, а хук возвращающий разметку и все требуемые функции: setState, removeItem и так далее. Либо делать отдельный хук с состоянием и всеми методами плюс компонент
    // TODO Пересмотри управление значками: убери лишние размеры, можно убрать задание класса (оставить только стандартный).
    // TODO Внедри обработчик раскрытия/скрытия папки.
    // TODO Продумай как ставить новый массив данных папок и файлов.
    // TODO Демонстрация перетаскивания: https://codesandbox.io/s/7k5z5vxjj?file=/src/index.js:104-117
