...
export default function App() {
    // TODO При подготовке статьи для показа нужно сделать состояние где будет храниться текущая стадия процесса. Например loading, preparation, ready, clearData. Это облегчит понимание когда следует запускать те или иные сценарии.
    ...
    // TODO В GET нельзя передать тело запроса, но дополнительные даные можно передать через запросы в URL: /compFolder?siteId=3. Поэтому я могу убрать обработчик /sites/3/compFolder из sites.
