...
export class SiteTemplateService {
    ...
    async getSiteTemplate(req: ExpressRequestInterface): Promise<SiteTemplateEntity> {
        return await this.siteTemplateRepository.findOne(req.params.siteTemplateId)
    }
    ...
    async updateSiteTemplate(
        ...
        const siteTemplate = await this.siteTemplateRepository.findOne({ id: siteTemplateId })
