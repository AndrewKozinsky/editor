...
export class ArtFolderService {
    ...
    async getArtFolderBySiteId(siteId: number): Promise<ArtFolderEntity> {
        return await this.artFolderRepository.findOne({ siteId })
    }
    ...
    async updateArtFolder(
        ...
        const artFolder = await this.artFolderRepository.findOne({ id: artFolderId })
    ...
    async deleteArtFolderBySiteId(
        ...
        const artFolder = await this.artFolderRepository.findOne({siteId})
