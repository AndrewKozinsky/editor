...
export class CompFolderService {
    ...
    async getCompFolderBySiteId(siteId: number): Promise<CompFolderEntity> {
        return await this.compFolderRepository.findOne({ siteId })
    }
    ...
    async updateCompFolder(
        ...
        const compFolder = await this.compFolderRepository.findOne({ id: compFolderId })
    ...
    async deleteCompFolderBySiteId(
        ...
        const compFolder = await this.compFolderRepository.findOne({siteId})
